...
internal class JsonFromNodeIdCollectionExtension<TId, TValue> : IExtension<FromNodeConversionState, IdCollection<TId, TValue>>
    where TId : notnull
    where TValue : class
{
    public void Extend(IdCollection<TId, TValue> context, IExtender<FromNodeConversionState> extender)
    {
