...
public class XmlFromNodeIdCollectionExtension<TId, TValue> : IExtension<FromNodeConversionState<XmlNode>, IdCollection<TId, TValue>>
    where TId : notnull
    where TValue : class
{
    public void Extend(IdCollection<TId, TValue> context, IExtender<FromNodeConversionState<XmlNode>> extender)
    {
