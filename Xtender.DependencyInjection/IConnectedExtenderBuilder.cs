...
namespace Xtender.DependencyInjection
{
    ...
    public interface IConnectedExtenderBuilder<TState>
    {
        ...
        IConnectedExtenderBuilder<TState> Attach<TContext, TExtension>(Func<TExtension> configuration) where TExtension : class, IExtensionBase;
    ...
    public interface IConnectedExtenderBuilder
    {
        ...
        /// <param name="configuration">The configuration lambda to resolve an Extension.</param>
        /// <returns>This same builder.</returns>
        IConnectedExtenderBuilder Attach<TContext, TExtension>(Func<TExtension> configuration) where TExtension : class, IExtension<TContext>;
